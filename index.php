...
<body>
  ...
  <main class="d-flex">
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary vh-100" style="width: 300px;">
      ...
      <hr>
      <div>
        <h5>Filtros de busqueda<svg class="bi pe-none ms-2" width="16" height="16">
            <use xlink:href="#lupa" />
          </svg></h5>
      </div>
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
          <select name="categoria" id="categoria" onchange="mostrarCampos()" class="form-select mt-3" aria-label="Default select example">
            <option value="" selected disabled>Seleccione una categoría</option>
            <option value="Alumno">Alumno</option>
            <option value="Profesor">Profesor</option>
            <option value="Profesor">PAS</option>
            <option value="Profesor">Monitor</option>
            <option value="Profesor">Practicas</option>
            <option value="Profesor">Profesor</option>
          </select>

          <!-- Campos especificos en el select alumno -->
          <div id="camposAlumno" class="hidden">
            <ul>
              <li>
                <select name="curso" id="curso" class="form-select mt-3" aria-label="Default select example">
          ...
          <!-- Campos especificos en el select profesor -->
          <div id="camposProfesor" class="hidden">
            <ul>
              <li>
                <select name="departamento" id="departamento" class="form-select mt-3" aria-label="Default select example">
                  <option value="" selected disabled>Seleccione un departamento</option>
                  <option value="1Bachiller">Matematica</option>
                  <option value="2Bachiller">Ingles</option>
                </select>
              </li>
              <li>
                <select name="etapa" id="etapa" class="form-select mt-3" aria-label="Default select example">
...
LEFT JOIN pas pa ON u.idUsuario = pa.idPas";  // Asegúrate de que la tabla "pas" esté unida correctamente
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          echo "
        <div class='modal fade' id='verPerfilModal$idUsuario' tabindex='-1' aria-labelledby='verPerfilModalLabel$idUsuario' aria-hidden='true'>
          ...
          // Modal para Editar
          echo "
        <div class='modal fade' id='editarUsuarioModal$idUsuario' tabindex='-1' aria-labelledby='editarUsuarioModalLabel$idUsuario' aria-hidden='true'>
            <div class='modal-dialog'>
                <div class='modal-content'>
                    <div class='modal-header'>
                        <h5 class='modal-title' id='editarUsuarioModalLabel$idUsuario'>Editar Usuario: $nombre $apellidos</h5>
                        <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                    </div>
                    <div class='modal-body'>
